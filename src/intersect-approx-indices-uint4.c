...
scalar_one_set (int *indices, int **init_indices, int **end_indices, const int A_index, const int B_index,
		...
		int deltaA, const unsigned int below_slop, const unsigned int above_slop,
		bool A_first_p) {
...
Intersect_approx_indices_uint4 (int *ndiagpairs,
  ...
  debug(printf("Entered Intersect_approx_indices with slop -%u and +%u with %d and %d items\n",
	       below_slop,above_slop,length1,length2));
